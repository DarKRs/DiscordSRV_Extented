...
public class DiscordSRV extends JavaPlugin {
    ...
    @Getter private EconomyWatchdog economyWatchdog;
    ...
    public void onEnable() {
        ...
        vh.onEnable();
        Bukkit.getPluginManager().registerEvents(new GameEconomyEvenetListener(), this);
        initThread.start();
    }
    ...
    public void init() {
        ...
        //Времено заменено на ручную синхронизацию
      /*  // start economy watchdog
        if (economyWatchdog != null && economyWatchdog.getState() != Thread.State.NEW) economyWatchdog.interrupt();
        economyWatchdog = new EconomyWatchdog();
        economyWatchdog.start();

        Bukkit.getScheduler().scheduleSyncRepeatingTask(this, new GameEconomyEvenetListener(), 60,20);*/
